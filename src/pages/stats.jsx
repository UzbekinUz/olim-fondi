    ...
    <section id="stats" className="py-20 bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          {/* Visual Stats Chart representation */}
          <div className="lg:col-span-7 bg-slate-800/60 border border-slate-700/60 rounded-3xl p-6 sm:p-8 flex flex-col justify-between">
            <div>
          ...
          {/* Detailed Table */}
          <div className="lg:col-span-5 bg-slate-800/40 border border-slate-700/60 rounded-3xl p-6 sm:p-8 flex flex-col justify-between overflow-x-auto">
            <div>
            ...
            {/* Stipendiantlar jami yutuqlari kichik paneli */}
            <div className="bg-slate-800/90 border border-slate-700/80 rounded-2xl p-4 mt-6">
